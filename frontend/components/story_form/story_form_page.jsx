  ...
  render(){
    return(
      <div className="story-form-background">
        <StoryFormHeader session={this.props.session} story={this.props.selectedStory} createStory={this.props.createStory} logout={this.props.logout} currentUser={this.props.session.currentUser} createTopicTags={this.props.createTopicTags}/>
