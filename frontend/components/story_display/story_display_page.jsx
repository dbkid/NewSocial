  ...
  render(){
    ...
    return(
      <div>
        ...
        <StoryDisplayFooter storyId={this.props.selectedStory.id} user={this.props.session.currentUser} createLike={this.props.createLike} likeCount={this.props.selectedStory.likeCount} liked={this.props.selectedStory.liked} createBookmark={this.props.createBookmark} bookmarked={this.props.bookmarked}/>
