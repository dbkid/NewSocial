    ...
    return(
      <div className="group">
        <div className="float-left">
          <TopicHeader topics={this.props.topics} createTopicFollow={this.props.createTopicFollow} deleteTopicFollow={this.props.deleteTopicFollow} currentUser={this.props.session.currentUser}/>
